...
with tab2:
    ...
    if datos_medios:
        ...
        st.info("Aún no hay medios de cultivo registrados en la base de datos.")# --- Función para insertar un nuevo registro ---
def insertar_medio_cultivo(nombre, ingrediente, concentracion, unidad):
    conn = None 
    cur = None
    try:
...
with tab2:
    ...
    if datos_medios:
        ...
        st.info("Aún no hay medios de cultivo registrados en la base de datos.")            conn.close() 
